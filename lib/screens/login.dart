...
import 'package:active_ecommerce_flutter/screens/dashboard/views/main.dart';
...
class _LoginState extends State<Login> {
  ...
  onPressedLogin() async {
    ...
    if (loginResponse.result == false) {
      ...
      await Get.find<DashboardController>().fetchCartData();
      Get.back();
    }
  }
          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 120.0, bottom: 15),
                    child: Container(
                      width: 75,
                      height: 75,
